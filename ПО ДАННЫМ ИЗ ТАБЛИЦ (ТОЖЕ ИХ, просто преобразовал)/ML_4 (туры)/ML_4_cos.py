...
similarity_scores = cosine_similarity(user_data, scaled_data)

# Найти 5 наиболее похожих туров
top_tour_indices = similarity_scores[0].argsort()[-5:][::-1]

# Вывод рекомендованных туров
recommended_tours = data.iloc[top_tour_indices]
